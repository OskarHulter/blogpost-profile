...
export const queryCode = `query FullQuery{root{myFirstAPIFilter exampleFlag}}`;

export const query: sdk.Query<sdk.ObjectValueWithVariables> = {"variableDefinitions":{},"fragmentDefinitions":{},"fieldQuery":{"Query":{"type":"InlineFragment","objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"type":"InlineFragment","objectTypeName":"Root","selection":{"myFirstAPIFilter":{"fieldArguments":{},"fieldQuery":null},"exampleFlag":{"fieldArguments":{},"fieldQuery":null}}}}}}}}};
  
/**
 * @deprecated use '@vercel/flags/providers/hypertune' package instead.
 */
export const vercelFlagDefinitions = {"myFirstAPIFilter":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/4230/main/draft/logic?selected_field_path=root%3EmyFirstAPIFilter","description":"My first api filter for testing."},"exampleFlag":{"options":[{"label":"Off","value":false},{"label":"On","value":true}],"origin":"https://app.hypertune.com/projects/4230/main/draft/logic?selected_field_path=root%3EexampleFlag"}};

export type FlagValues = {
  "myFirstAPIFilter": boolean;
  "exampleFlag": boolean;
}
...
export type Root = {
  /**
   * My first api filter for testing.
   */
  myFirstAPIFilter: boolean;
  exampleFlag: boolean;
}

const rootFallback = {myFirstAPIFilter:false,exampleFlag:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * My first api filter for testing.
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/4230/main/draft/logic?selected_field_path=root%3EmyFirstAPIFilter})
   */
  myFirstAPIFilter({ args = {}, fallback }: { args?: Rec; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("myFirstAPIFilter", { fieldArguments: args });
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/4230/main/draft/logic?selected_field_path=root%3EexampleFlag})
   */
...
const sourceFallback = {root:{myFirstAPIFilter:false,exampleFlag:false}};
